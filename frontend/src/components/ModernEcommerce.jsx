        ...
        <div className="flex gap-6">
                  ...
                  >
                    ...
                    <ChevronRight
                      ...
                      className={`transition-transform ${
                        selectedCategory === cat.id ? "translate-x-1" : ""
                      }`}
                    />
                  </button>
                ))}
          ...
          <main className="flex-1">
            ...
            <div className="bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 rounded-2xl p-8 mb-6 text-white shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-purple-100 mb-4">
                  Curated just for you with AI technology
                </p>
                  ...
                  {products
                    ...
                    .map((product) => {
                      ...
                      return (
                        <div
                          key={productId}
                          className="bg-white rounded-xl p-4 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-1 border border-purple-100 cursor-pointer"
                        >
            ...
            {products.length > 0 ? (
             ...
             <div
  key={productId}
  className="group relative bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-gray-100"
>
  {/* Product Image Container */}
  <div className="relative bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 p-10 overflow-hidden">
    {/* Decorative Background Elements */}
    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
      <div className="absolute top-0 right-0 w-32 h-32 bg-purple-200 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-32 h-32 bg-blue-200 rounded-full blur-3xl"></div>
    </div>
    
    <div className="relative text-center transform group-hover:scale-110 transition-transform duration-500">
      {productImage ? (
        <img
          src={productImage}
          alt={productName}
  ...
  <div className="p-6 space-y-4">
    <h3 className="font-bold text-xl mb-3 line-clamp-2 text-gray-800 group-hover:text-purple-600 transition-colors duration-300">
      {productName}
    </h3>
    ...
    <button
      ...
      className="relative w-full bg-gradient-to-r from-purple-600 via-purple-500 to-blue-600 text-white px-6 py-3.5 rounded-2xl font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-2xl overflow-hidden group/btn"
    >
      {/* Button Shine Effect */}
